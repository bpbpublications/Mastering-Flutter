...
String _$movieAPIServiceHash() => r'91b18805e2e87a0723c68c7274250882c3820a5c';

/// See also [movieAPIService].
@ProviderFor(movieAPIService)
final movieAPIServiceProvider = FutureProvider<MovieAPIService>.internal(
  movieAPIService,
...
typedef MovieAPIServiceRef = FutureProviderRef<MovieAPIService>;
String _$networkMovieSourceHash() =>
    r'b98f268ca092f7a18f456b4b290a0f3497f9196e';

/// See also [networkMovieSource].
@ProviderFor(networkMovieSource)
final networkMovieSourceProvider = FutureProvider<MovieSource>.internal(
  networkMovieSource,
...
typedef NetworkMovieSourceRef = FutureProviderRef<MovieSource>;
String _$movieRepositoryHash() => r'2ec6b947a839ff39a0d23b9f9d3fc3767169a163';
...
String _$prefsHash() => r'a1e38574dd418d46fa6ebc6d7503e8b424b7c33c';

/// See also [prefs].
@ProviderFor(prefs)
final prefsProvider = Provider<Prefs>.internal(
  prefs,
...
typedef PrefsRef = ProviderRef<Prefs>;
String _$moviePluginHash() => r'fb81b3c525adbe7f7869d994502a896a2682df2e';

/// See also [moviePlugin].
@ProviderFor(moviePlugin)
final moviePluginProvider = Provider<MoviePlugin>.internal(
  moviePlugin,
  name: r'moviePluginProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$moviePluginHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef MoviePluginRef = ProviderRef<MoviePlugin>;
